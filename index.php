...
<!-- STEP 1: Insert an IMG element with the src attribute pointing to the image called "mini-figure" in the 'images' directory -->
               <figure>
				 <figcaption> Mini figure by Vanja (Public Domain)
					<img src="images/mini-figure.png" alt="Mini figur" height="100" width="100" />
				</figcaption> 
               </figure><!-- STEP 2: Add an alt attribute with a short phrase that describes the image -->
